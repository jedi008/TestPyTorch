...
class Conv(nn.Module):
    ...
    def __init__(self, c_in=3, c_out=32, kernel_size=1, stride=1, p=None, g=1, act=True):  # ch_in, ch_out, kernel, stride, padding, groups
        super(Conv, self).__init__()
        self.conv = nn.Conv2d(c_in, c_out, kernel_size, stride, autopad(kernel_size, p), groups=g, bias=False)
