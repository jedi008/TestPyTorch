...
def main():
    ...
    if use_V2:
        ...
        model_weight_path = image_path = os.path.join(current_dir, "weights", "mobilenet_v2-b0353104.pth")
        ...
        save_path = os.path.join(current_dir, "weights", "save", "MobileNetV2.pth")
    else:
        ...
        save_path = os.path.join(current_dir, "weights", "save", "MobileNetV3.pth")
