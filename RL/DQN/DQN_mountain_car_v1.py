...
class Dqn():
    ...
    def store_trans(self, state, action, reward, next_state):
        ...
        # print("state: ", state) # [-0.43157494  0.        ]
        trans = np.hstack((state, [action], [reward], next_state))
        # print("trans: ", trans) # [-4.31574941e-01  0.00000000e+00  1.00000000e+00 -5.00000000e+00 -4.32256371e-01 -6.81445119e-04]
    ...
    def choose_action(self, state):
        ...
        # 1-EPSILON的概率随机探索操作，EPSILON的概率正常计算输出
